    ...
    public static class DepotManager
    {
        ...
        static DepotManager()
        {
            depots = new List<Depot>
            {
                ...
                new (377166, 783101348965844295 , "Fallout in Italian", "italian", DepotTarget.Game),
                ...
                new (435876, 6475533526946306248, "Automatron Polish", DepotTarget.RequiredDlc),
                new (404091, 6756984187996423348, "Automatron Japanese", DepotTarget.RequiredDlc),
                new (435874, 9032251103390457158, "Automatron Italian", DepotTarget.RequiredDlc),
                new (435878, 8276750634369029613, "Automatron portuguese", DepotTarget.RequiredDlc),
                new (435873, 2207548206398235202, "Automatron german", DepotTarget.RequiredDlc),
                new (435875, 2953236065717816833, "Automatron spanish", DepotTarget.RequiredDlc),
                new (435879, 367504569468547727, "Automatron Traditional Chinese", DepotTarget.RequiredDlc),
                new (435872, 5590419866095647350, "Automatron French", DepotTarget.RequiredDlc),
                ...
                new (435887, 1696734609684135531, "Far Harbor Polish", DepotTarget.AllDlc),
                new (404093, 1398706778481280442, "Far Harbor Japanese", DepotTarget.AllDlc),
                new (435885, 545294059663977441, "Far Harbor Italian", DepotTarget.AllDlc),
                new (435889, 3739447432423498108, "Far Harbor portuguese", DepotTarget.AllDlc),
                new (435884, 1583726361179064237, "Far Harbor german", DepotTarget.AllDlc),
                new (435886, 6337694505107499720, "Far Harbor spanish", DepotTarget.AllDlc),
                new (404092, 6806984433357643395, "Far Harbor Traditional Chinese", DepotTarget.AllDlc),
                new (435883, 8148702710057205377, "Far Harbor French", DepotTarget.AllDlc),
                ...
                new (393890, 1765554658221186452, "Vault-Tec Workshop Polish", DepotTarget.AllDlc),
                new (393894, 284738489375199037, "Vault-Tec Workshop Japanese", DepotTarget.AllDlc),
                new (393888, 4182964460983125860, "Vault-Tec Workshop Italian", DepotTarget.AllDlc),
                new (393892, 1388883862084490494, "Vault-Tec Workshop portuguese", DepotTarget.AllDlc),
                new (393887, 4458604458983717666, "Vault-Tec Workshop german", DepotTarget.AllDlc),
                new (393889, 7553859846726526417, "Vault-Tec Workshop spanish", DepotTarget.AllDlc),
                new (393893, 442593679549850747, "Vault-Tec Workshop Traditional Chinese", DepotTarget.AllDlc),
                new (393886, 4075502974578231964, "Vault-Tec Workshop French", DepotTarget.AllDlc),
                ...
                new (404097, 3040241873036299160, "Nuka World Polish", DepotTarget.AllDlc),
                new (377169, 2112185424871906435, "Nuka-World Italian", DepotTarget.AllDlc),
                new (404096, 2951208112779014496, "Nuka-World Japanese", DepotTarget.AllDlc),
                new (404094, 2888111047071072771, "Nuka-World portuguese", DepotTarget.AllDlc),
                new (393897, 1357704281835463005, "Nuka-World german", DepotTarget.AllDlc),
                new (393898, 8573679706590820412, "Nuka-World spanish", DepotTarget.AllDlc),
                new (404095, 3169890264626778200, "Nuka-World Traditional Chinese", DepotTarget.AllDlc),
                new (393896, 4271967849859961419, "Nuka-World French", DepotTarget.AllDlc),
